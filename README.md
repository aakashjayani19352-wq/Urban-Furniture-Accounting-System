...
| **Chandan Shah** | [@cshah0220226](https://github.com/cshah0220226) | **Backend Core & Architecture**: FastAPI application setup, SQLite/PostgreSQL database models, RESTful endpoints, seed data engine, JWT authentication & RBAC. |
